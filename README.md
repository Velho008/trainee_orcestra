...
### Sobre o projeto
Este é o projeto do site institucional da InovaTech, desenvolvido como parte do Processo Trainee da Orc'estra Gamificação.
Teve como objetivo criar uma landing page moderna, funcional e totalmente responsiva, aplicando os conceitos fundamentais de desenvolvimento web (HTML5, CSS3 e JavaScript) em um ambiente de equipe com controle de versão (Git).

### Principais funcionalidades:
- **Design Responsivo:** O site se adapta perfeitamente a todos os tamanhos de tela (desktop, tablet e celular).
